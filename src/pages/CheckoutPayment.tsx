...
import { getInfoDetails } from "./CheckoutInformation";
...
const paymentMethods = [
    { name: 'Club ID', src: 'https://cdn.shopify.com/s/files/1/0629/7881/8265/files/clubid.png' },
    { name: 'Bancontact', src: 'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/bancontact-5025a18e9848062fdad79279079e840ec3ea36bd223dc3a77b7b3074efa8d638.svg' },
    { name: 'KBC/CBC', src: 'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/kbc_cbc-fa91cb17a1243415b94a9898bf019b0df9cf458f0780237551e4d36be21ed9bc.svg' },
    { name: 'Belfius', src: 'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/belfius-8b2b5dd319c79afe6dbe9aaeece6193d89d1a30232e53fa1394ba3978f1e79b4.svg' },
    { name: 'iDeal', src: 'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/ideal-79b531d1693f36c4ab8e92f337a8a920dd052c1119499abc198e0dc04d32ee30.svg' },
    { name: 'Paypal', src: 'https://cdn.shopify.com/shopifycloud/shopify/assets/checkout/offsite-gateway-logos/paypal@2x-768388b0667bef1aa9a7cf02fa1cc2184c2915a90d4cdd62dde223f74f2acbfc.png' },
    {
        name: 'Credit/Debit Card', src: [
            'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/visa-319d545c6fd255c9aad5eeaad21fd6f7f7b4fdbdb1a35ce83b89cca12a187f00.svg',
            ...
            'https://cdn.shopify.com/shopifycloud/shopify/assets/payment_icons/cartes_bancaires-ad50cf789d5354f733fea24cf4d0a73b4a2843080e3b5607a6f05445c2cd206b.svg'
        ]
    },
]

const deleteTokens = () => {
    return axios.delete(`${config.BACKEND_ENDPOINT}/checkout`, { withCredentials: true });
}



function CheckoutPayment() {
    const [currentStage, setCurrentStage] = useState<CheckoutStatus>('Payment');
    ...
    return (
        <>
            <div className='w-[100vw] h-[100vh] bg-[#f4f7f8] flex gap-[30px]'>
                <div className='ml-[50px] mt-[50px] w-[55vw] flex flex-col gap-[30px]'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='greyLine my-[15px]' />
                        <div className='flex items-center justify-between gap-[40px]'>
                            <div className='text-[13px] text-softGrey w-[70px]'>Mode</div>
                            <div className='flex justify-between items-center w-[100%]'>
                                <div className='text-[15px] text-midGrey'>{paymentMode}</div>
                            </div>
                        </div>
                        <div className='uppercase bebas text-[34px] text-[#313132] mt-[50px]'>Payment method</div>
                        <div className='text-[15px] text-[#2a3548] '>All transactions are secured and encrypted</div>
                    ...
                    >
                        ...
                        <div className='flex flex-col gap-[10px] mt-[15px]'>
                            {paymentMethods.map((method) => {
                                return <div className='flex justify-between border-b-[1px] py-[10px]'>
                                    <div className="flex text-[15px] gap-[10px] text-[#333]">
                                        <input
                                            type='radio'
                                            name='paymentMethod'
                                            value={method.name}
                        ...
                        <div className='w-[100%] mt-[50px] bebas'
                            onClick={() => {
                        ...
                        >
                            <BlueButton width='100%'>Complete order</BlueButton>
                        </div>
                    </div>
                </div>
            ...
            {showModal && <motion.div
                className='border-[1px] border-softGrey flex-col gap-[30px] absolute top-[50%] left-[50%] rounded-[10px] w-[600px] h-[300px] bg-white flex items-center justify-center'
                style={{ transform: 'translate(-50%,-50%)' }}
                initial={{ opacity: 0.8, top: "0%" }}
            ...
            >
                <motion.svg initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} width='100px' version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
                    <circle className="path circle" fill="none" stroke="#73AF55" strokeWidth="6" strokeMiterlimit="10" cx="65.1" cy="65.1" r="62.1" />
                    <polyline className="path check" fill="none" stroke="#73AF55" strokeWidth="6" strokeLinecap="round" strokeMiterlimit="10" points="100.2,40.2 51.5,88.8 29.8,67.5 " />
                </motion.svg>
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className='text-[36px]'>Payment successful</motion.div>
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className='text-[12px]'>Redirecting you to the site...</motion.div>
            </motion.div >
            }
        </>
    )
